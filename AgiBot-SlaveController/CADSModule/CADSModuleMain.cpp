...
class CCADSModuleCtrl : public ITcOCFCtrlImpl<CCADSModuleCtrl, CCADSModuleClassFactory>
{
public:
	CCADSModuleCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("CADSModule: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CCADSModuleCtrl>;
