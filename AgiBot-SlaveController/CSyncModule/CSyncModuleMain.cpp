...
class CCSyncModuleCtrl : public ITcOCFCtrlImpl<CCSyncModuleCtrl, CCSyncModuleClassFactory>
{
public:
	CCSyncModuleCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("CSyncModule: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CCSyncModuleCtrl>;
