...
class CCSyncModulesCtrl : public ITcOCFCtrlImpl<CCSyncModulesCtrl, CCSyncModulesClassFactory>
{
public:
	CCSyncModulesCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("CSyncModules: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CCSyncModulesCtrl>;
